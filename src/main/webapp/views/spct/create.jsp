                ...
                <form action="/spct/store" method="post">
                    ...
                    <div class="my-3">
                        ...
                        <select name="idSanPham" class="form-select me-2">
                            <c:forEach var="i" items="${listSP}">
                                <option value="${i.id}" ${i.id == data.sanPham.id ? 'selected' : ''}>${i.ten}</option>
                            </c:forEach>
                        </select>
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <select name="idMauSac" class="form-select me-2">
                            <c:forEach var="i" items="${listMS}">
                                <option value="${i.id}" ${i.id == data.mauSac.id ? 'selected' : ''}>${i.ten}</option>
                            </c:forEach>
                        </select>
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <select name="idKichThuoc" class="form-select me-2">
                            <c:forEach var="i" items="${listKT}">
                                <option value="${i.id}" ${i.id == data.kichThuoc.id ? 'selected' : ''}>${i.ten}</option>
                            </c:forEach>
                        </select>
                    </div>
                    ...
                    <div class="my-3">
                        ...
                        <select class="form-select" name="trangThai">
                            <option value="0" ${data.trangThai == 0 ? 'selected' : ''}>Hoạt động</option>
