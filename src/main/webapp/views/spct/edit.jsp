    ...
    <div class="main">
        ...
        <%--Body--%>
            <div class="box container my-2">
                ...
                <form action="/spct/update/${spct.id}" method="post">
                    <div class="my-3">
                        <label class="form-label">Mã SPCT</label>
                        <input class="form-control" type="text" name="ma" value="${spct.ma}">
                    ...
                    <div class="my-3">
                        ...
                        <select name="sanPham" class="form-select me-2">
                            <c:forEach var="sanPham" items="${listSP}">
                                <option value="${sanPham.id}" ${sanPham.id == spct.sanPham.id ? "selected":""}>${sanPham.ten}</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="my-3">
                        <label class="form-label">Tên màu sắc</label>
                        <select name="mauSac" class="form-select me-2">
                    ...
                    <div class="my-3">
                        ...
                        <select name="kichThuoc" class="form-select me-2">
                    ...
                    <div class="my-3">
                        ...
                        <select class="form-select" name="trangThai">
                            <option value="0" ${spct.trangThai == 0 ? "selected":""}>Hoạt động</option>
                            <option value="1" ${spct.trangThai == 1 ? "selected":""}>Ngừng hoạt động</option>
                        </select>
                    </div>
                    <div class="my-3">
