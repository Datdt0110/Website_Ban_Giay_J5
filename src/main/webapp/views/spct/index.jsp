...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="box container my-2">
            <h2>Danh sach sản phẩm chi tiết</h2>
            <div class="d-flex justify-content-between">
                <form action="/spct/index" method="get" class="d-flex align-items-center">
                    <label class="form-label">Sản phẩm :</label>
                    <div class="row mx-2">
                        <div class="col-md-15">
                            <select name="sanPham" id="sanPham" class="form-select me-2">
            ...
            <nav>
                <ul class="pagination d-flex justify-content-center">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/spct/index?page=${currentPage + 1}&size=${pageSize}">Next</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                </ul>
