        ...
        <%--Body--%>
            <div class="box container my-2">
                ...
                <form action="/hdct/update/${listHDCTDetail.id}" method="post">
                    <!-- Input ẩn cho ID hóa đơn -->
                    <input type="hidden" name="hoaDon" value="${listHDCTDetail.hoaDon.id}">

                    <!-- Input ẩn cho ID sản phẩm chi tiết -->
                    <input type="hidden" name="spct" value="${listHDCTDetail.spct.id}">

                    <div class="my-3">
                        <label class="form-label">Số lượng</label>
                        <input class="form-control" type="text" name="soLuong" value="${listHDCTDetail.soLuong}">
                    ...
                    <div class="my-3">
                        ...
                        <input class="form-control" type="text" name="donGia" value="${listHDCTDetail.donGia}">
                    ...
                    <div class="my-3">
                        ...
                        <select class="form-select" name="trangThai">
                            <option value="0" ${listHDCTDetail.trangThai == 0 ? "selected" : ""}>Đã thanh toán</option>
                            <option value="1" ${listHDCTDetail.trangThai == 1 ? "selected" : ""}>Chưa thanh toán</option>
                        </select>
                    </div>
                    <div class="my-3">
