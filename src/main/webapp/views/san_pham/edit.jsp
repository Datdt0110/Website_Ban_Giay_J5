...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="box container my-2">
            <h2>Sửa sản phẩm </h2>
            <form action="/san-pham/update/${listSPDetail.id}" method="post">
                <div class="my-3">
                    <label class="form-lable">Mã sản phẩm</label>
                    <input class="form-control" type="text" name="ma" value="${listSPDetail.ma}">
                ...
                <div class="my-3">
                    ...
                    <input class="form-control" type="text" name="ten" value="${listSPDetail.ten}">
                ...
                <div class="my-3">
                    ...
                    <select id="" class="form-select" name="trangThai">
                        <option value="0"${listSPDetail.trangThai ==0 ? "selected":""}>Hoạt động</option>
                        <option value="1"${listSPDetail.trangThai ==1 ? "selected":""}>Ngừng hoạt động</option>
                    </select>
                </div>
                <div class="my-3">
