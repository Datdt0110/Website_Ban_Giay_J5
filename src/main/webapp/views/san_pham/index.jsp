...
<body >
<div class="wrapper text-bg-dark" >
    <%--Menu--%>
            ...
            <table class="table">
                ...
                <c:forEach items="${listSP}" var="sp">
                    <tr>
                        ...
                        <td>${sp.ma}</td>
                        <td>${sp.ten}</td>
                        <td>${sp.trangThai==0 ? "Hoạt Động":"Ngừng Hoạt Động"}</td>
                        <td>
            ...
            <nav>
                <ul class="pagination d-flex justify-content-center">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/san-pham/index?page=${currentPage - 1}&size=${pageSize}">Previous</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                    <!-- Page Numbers -->
                    <c:forEach var="i" begin="1" end="${totalPages}">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a class="page-link" href="/san-pham/index?page=${i}&size=${pageSize}">${i}</a>
                        </li>
                    </c:forEach>
                    <!-- Next Button -->
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link" href="/san-pham/index?page=${currentPage + 1}&size=${pageSize}">Next</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                </ul>
