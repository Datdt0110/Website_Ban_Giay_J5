                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${listHD}" var="hd">
                                <tr>
                                    ...
                                    <td>${hd.hienThiTT()}</td>
                                    <td>
                                        <a class="btn btn-dark" href="/ban-hang/selectHD/${hd.id}">Chọn</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                    ...
                    <div class="col-5">
                        ...
                        <form action="/ban-hang/tao-hoa-don/${loggedInUser.id}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    <button class="btn btn-dark" type="submit">Tạo hoá đơn</button>
                                    <form action="/ban-hang/thanh-toan" method="post" style="display: inline;">
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${listSPCT}" var="sp">
                            <tr>
                                ...
                                <td>${sp.donGia}</td>
                                <td>
                                    <a class="btn btn-dark" href="/ban-hang/selectSPCT/${sp.id}">Chọn mua</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
...
<script>
    function clearForm() {
        document.getElementsByName("sdtKH")[0].value = "";
        document.getElementsByName("tenKH")[0].value = "";
        document.getElementsByName("idHoaDon")[0].value = "";
        document.getElementsByName("tongTien")[0].value = "";
    }
</script>
