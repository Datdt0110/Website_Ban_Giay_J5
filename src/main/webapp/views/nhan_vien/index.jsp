    ...
    <div class="main">
        ...
        <div class="box container my-2">
            ...
            <div class="d-flex justify-content-between">
                <form action="/nhan-vien/index" method="get" class="d-flex align-items-center">
                    <div class="row mx-2">
                        <div class="col-md-15">
                ...
                <div class="my-3">
                    <a class="btn btn-dark" href="/nhan-vien/create">Tạo mới</a>
                    <a class="btn btn-dark" href="/nhan-vien/export">Xuất file excel</a>
                    <form action="/nhan-vien/import" method="post" enctype="multipart/form-data" class="d-inline">
                        <input type="file" name="file" accept=".xlsx" required />
                        <button class="btn btn-dark" type="submit">Nhập từ file excel</button>
                    </form>
                </div>
            </div>
            <table class="table">
