            ...
            <form action="/nhan-vien/store" method="post">
                ...
                <div class="my-3">
                    ...
                    <select class="form-select" name="trangThai">
                        <option value="0" <c:if test="${data.trangThai == 0}">selected</c:if>>Hoạt động</option>
                        <option value="1" <c:if test="${data.trangThai == 1}">selected</c:if>>Ngừng hoạt động</option>
                    </select>
                </div>
                <div class="my-3">
